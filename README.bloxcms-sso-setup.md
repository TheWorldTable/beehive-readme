...
**Step 6)** To add World Table as a client, click on the "Client sites" tab (see above image), then click "Add." Type "World Table" under Name then click "Add" and type in the domain: "https:/...worldtable.co"
